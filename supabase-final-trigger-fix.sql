-- Final fix for user registration trigger function
-- Date: 2025-01-14
-- Issue: User registration failing due to deleted fields in trigger function
-- Status: RESOLVED - Trigger recreated and working

-- 最终修复 handle_new_user 触发器函数
...
BEGIN
  ...
  -- Insert new user profile (使用当前数据库结构)
